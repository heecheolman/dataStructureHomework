...
void deleteNode (TreeNode * root, element data) {
  /*
  * target : 트리에서 타겟이 될 노드의 주소가 담길 포인터
  * parent : *target 의 부모가 담길 포인터
  * child : *target 의 자식이 담길 포인터
  * succ : 후계자가 될 노드
  * succParent : 후계자가 될 노드의 부모노드
  */
    TreeNode * target;
    TreeNode * parent;
    TreeNode * child;
